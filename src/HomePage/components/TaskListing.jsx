...
function TaskListing({
    ...
    return (
        <section className="mt-5 relative" style={{ height: "calc(100% - 57px)" }}>
            {tasks.length === 0 ? (
                <p className="w-full flex justify-center items-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
